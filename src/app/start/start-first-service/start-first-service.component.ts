...
@Component({
  selector: 'app-start-first-service',
  templateUrl: './start-first-service.component.html',
  styleUrls: ['./start-first-service.component.css']
})
export class StartFirstServiceComponent implements OnInit {
  icons = [
    {
      'title': 'Facebook',
  ...
  ServiceDialog(service) {
    let dialogRef = this.dialog.open(StartAddServiceComponent, {data: service, });
  }
  ngOnInit() {
...
@Component({
  selector: 'app-start-first-service',
  templateUrl: './start-add-service.component.html',
})
export class StartAddServiceComponent {
